  ...
  return (
    <div className="xone-docs-page">
      <header className="xone-docs-header">
        ...
        <div className="xone-docs-header-actions"><Link to="/" className="xone-docs-header-link">Product</Link><a href={XONE_LINKS.repository} target="_blank" rel="noreferrer" className="xone-docs-header-link">Source <ArrowRight size={14} /></a><AnimatedThemeToggler className="xone-docs-theme-toggle" aria-label="Toggle light and dark mode" /><a href="/#downloads" className="xone-docs-header-button">Download Desktop <Download size={15} /></a></div>
      </header>
      <div className="xone-docs-layout">
        ...
        <main className="xone-docs-main">
          <section id="overview" className="xone-docs-hero"><div><span className="xone-docs-kicker"><GitBranch size={14} /> XONE DOCS · PRIVATE AI OPERATIONS</span><h1>One control plane for models, knowledge, and agents.</h1><p>XOne is a local AI workspace for running models, grounding answers in private data, connecting tools through MCP, and moving from experiment to an observable API.</p><div className="xone-docs-hero-actions"><a href="/#downloads" className="xone-docs-primary"><Download size={16} /> Download Desktop</a><a href="#install" className="xone-docs-secondary"><Terminal size={16} /> Start from a terminal</a></div></div><div className="xone-docs-signal"><div className="xone-docs-signal-top"><span><i /> X1 CONTROL PLANE</span><code>LOCAL / READY</code></div><div className="xone-docs-signal-core"><img src={XONE_BRAND.icons.app} alt="" /><strong>Private by design</strong><small>Models, tools, and context remain observable.</small></div><div className="xone-docs-signal-grid"><span><CheckCircle2 /> Runtime</span><span><CheckCircle2 /> Retrieval</span><span><CheckCircle2 /> Tooling</span><span><CheckCircle2 /> API</span></div></div></section>
