    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-1.5">
        ...
        <p id={tokenHelpId} className="text-xs text-muted-foreground">
          {usingEnvToken
            ? "XOne detected a server env token, so saved/shared recipes can leave this blank."
            : "Blank is safest for saved/shared recipes because XOne will read the server environment at run time."}
        </p>
        {hasToken && (
      ...
      <p className="text-xs text-muted-foreground">
        Backed by XOne's built-in <code>github_repo</code> seed reader. Large
